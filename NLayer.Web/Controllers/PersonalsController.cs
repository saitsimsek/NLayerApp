...
namespace NLayer.Web.Controllers
{
    public class PersonalsController : Controller
    {
        ...
        {
            var personalDto = await _projectApiService.GetAllAsync();
            ViewBag.personal = new SelectList(personalDto, "Id", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Save(PersonalDto personalDto)
        {
            ...
            ViewBag.personal = new SelectList(projectsDto, "Id", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Update(int id)
        {
            ...
            var projectsDto = await _projectApiService.GetAllAsync();
            ViewBag.personal = new SelectList(projectsDto, "Id", "Name", personal.Id);
        ...
        public async Task<IActionResult> Update(PersonalDto personalDto)
        {
            ...
            var projectsDto = await _projectApiService.GetAllAsync();
            ViewBag.personal = new SelectList(projectsDto, "Id", "Name", personalDto.Id);
